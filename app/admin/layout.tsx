      ...
      <header className="border-b bg-background">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
          ...
          <nav className="flex items-center gap-4">
            ...
            <Link href="/admin/onboarding-gaps" className="text-sm text-muted-foreground hover:text-foreground">
              연락 대상
            </Link>
            <Link href="/admin/activity" className="text-sm text-muted-foreground hover:text-foreground">
              사용 현황
            </Link>
            <Link href="/admin/growth" className="text-sm text-muted-foreground hover:text-foreground">
              그로스
            </Link>
            ...
            <Link href="/admin/domain-outreach" className="text-sm text-muted-foreground hover:text-foreground">
              주소 권유
            </Link>
