...
export default async function SettingsPage() {
  ...
  const [businessResult, subscriptionResult, serviceCountResult] = await Promise.all([
    db
      .from('businesses')
      .select('id, name, phone, address, description, naver_place_url, google_place_url, danggeun_review_url, kakao_place_url, active_review_platform, youtube_url, instagram_url, service_areas, review_reward_type, review_reward_description, slug, seo_title, seo_description, seo_keywords, seo_faqs, seo_generated_at, logo_url, hero_image_url, brand_color, brand_color_secondary, hero_style, hero_title, hero_subtitle, testimonials' as never)
  ...
  const business = businessResult.data as unknown as {
    ...
    instagram_url: string | null; service_areas: string[] | null
