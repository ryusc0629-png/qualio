...
export const FALLBACK_PITCH: QuotePitch = {
  ...
  subheadline: '숙련된 전문 팀이 직접 투입되어 꼼꼼하게 작업합니다',
  reasons: [
  ...
  tierReasons: {
    better: '추천 플랜은 기본 케어에서 한 단계 더 나아가 꼼꼼한 관리가 필요한 부분까지 처리합니다. 한 번 제대로 관리해두면 이후 유지가 훨씬 쉬워집니다.',
    best: '프리미엄 플랜은 전문 장비와 고급 케미컬로 가장 깊은 수준의 케어를 제공합니다. 지금 함께 하시면 별도 방문 비용 없이 최상의 결과를 얻으실 수 있습니다.',
  },
  tierIncludes: {
    good: [
      '기본 항목 전체 포함',
