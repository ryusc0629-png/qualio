...
// 사무실·상가·매장·병원 등 상업시설 대청소 (B2B)
const COMMERCIAL: QuoteTemplate = {
  id: 'commercial',
  label: '상업시설 대청소 인기 구성',
  description: '사무실·상가·매장·병원 등 상업공간 대청소 구성',
  keywords: ['사무실', '상가', '오피스', '매장', '병원', '상업', '입점', '건물', '대청소', '점포', '학원', '카페', '식당'],
  // 기본: 전 구역 표준 대청소
  good: [
    '바닥 쓸기·밀걸레·집기 먼지 제거',
    '공용부·복도·계단 청소',
...
// 인테리어/시공 후 청소 (준공청소) — 분진 제거 중심
const INTERIOR: QuoteTemplate = {
  id: 'interior',
  label: '인테리어 후 청소(준공) 인기 구성',
  description: '시공·인테리어 후 분진 제거 중심 구성',
  keywords: ['인테리어', '준공', '분진', '입주전', '시공후', '리모델링'],
  // 기본: 분진(먼지) 제거 + 시공 자국 제거
  good: [
    '전체 분진(먼지) 제거·바닥 청소',
    '바닥 보양재·페인트·시멘트 자국 제거',
    '창틀·문틀·걸레받이 분진 제거',
    '주방 싱크대·수납장 내·외부',
    '욕실 변기·세면대·타일 백시멘트 제거',
  ],
  // 추천: 마감 디테일 + 자국 제거
  better: [
    '유리창 안팎·새시 홈 분진',
