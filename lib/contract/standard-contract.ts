...
export function buildStandardContractText(i: StandardContractInput): string {
  ...
  lines.push('')
  lines.push('제3조 (계약 기간) 계약 기간은 위 계약 개요에 정한 바에 따른다. 기간 만료 30일 전까지 양 당사자의 별도 의사표시가 없으면 동일 조건으로 1년간 자동 연장된다.')
  lines.push('')
  lines.push(`제4조 (계약 금액 및 지급) ${payClause}`)
  lines.push('')
  lines.push('제5조 (“을”의 의무) “을”은 선량한 관리자의 주의로 성실히 용역을 수행하며, 작업 인력에 대한 교육·관리 및 4대보험·안전관리 책임을 진다.')
  lines.push('')
  lines.push('제6조 (“갑”의 의무) “갑”은 용역 수행에 필요한 장소·전기·수도 등 기본 여건을 제공하고, 정당한 사유 없이 용역 수행을 방해하지 아니한다.')
  lines.push('')
  lines.push('제7조 (손해배상 및 보험) “을”은 용역 수행 중 “을”의 귀책으로 “갑”에게 발생한 손해를 배상하며, 이를 위하여 배상책임보험에 가입할 수 있다.')
  lines.push('')
  lines.push('제8조 (계약의 해지) 일방이 본 계약을 위반하고 상대방의 시정 요구 후 7일 이내에 시정하지 아니한 경우 상대방은 계약을 해지할 수 있으며, “갑”과 “을”은 30일 전 서면 통지로 계약을 해지할 수 있다.')
  lines.push('')
