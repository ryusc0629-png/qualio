...
import { LayoutDashboard, LogOut, Wrench, FileText, Calendar, Settings, Users, UserCheck, FileSignature } from 'lucide-react'
...
export function Sidebar({ businessName }: SidebarProps) {
  ...
  const navItems = [
    ...
    { href: '/dashboard/customers', label: '고객 관리', icon: UserCheck },
    { href: '/dashboard/contracts', label: '정기계약', icon: FileSignature },
