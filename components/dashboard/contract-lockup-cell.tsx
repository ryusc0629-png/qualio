          ...
          <div className="space-y-5 py-1">
            ...
            <div className="space-y-2 border-t pt-4">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                {/* ⛔체크리스트를 거래처 월간 보고서에 싣지 말 것 — 2026-08-22 대표 확정.
                    "체크리스트는 근태 관리일 뿐이에요. 사장이 현장 직원의 업무를 파악할 뿐이죠.
                     고객사는 알 필요가 없어요. 고객은 원하는 청소 결과만 얻으면 되니까요."
                    → 이건 사장님이 직원을 보는 내부 도구다. 고객 문서에 넣지 말 것.
                    (거래처에 나가는 건 결과 — 특이사항·요청 처리 내역과 그 사진) */}
